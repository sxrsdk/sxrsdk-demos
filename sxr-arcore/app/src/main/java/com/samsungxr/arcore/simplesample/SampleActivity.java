...
public class SampleActivity extends SXRActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    private static final String TAG = "SXR_ARCORE";
