...
public class SphereStaticList {
    ...
    public void updateSpheresMaterial() {
        ...
        for (SXRSceneObject sphereFlag : listFlag) {
            ...
            float x = 0;// this.getSXRContext().getMainScene().getMainCameraRig().getOwnerObject().getTransform().getPositionX();
            float y = 0;// this.getSXRContext().getMainScene().getMainCameraRig().getOwnerObject().getTransform().getPositionY();
            float z = 0;// this.getSXRContext().getMainScene().getMainCameraRig().getOwnerObject().getTransform().getPositionZ();
