...
public class Util {
    ...
    public static float[] calculatePointBetweenTwoObjects(SXRTransform object, Vector3D vector,
            float desiredDistance) {
        float[] point = new float[3];
        float ratio = desiredDistance / (float) distance(vector, object);
    ...
    public static double distance(Vector3D vector, SXRTransform object) {
