...
package com.samsungxr.videoplayer.component.video;
...
import com.samsungxr.videoplayer.component.video.backbutton.BackButton;
import com.samsungxr.videoplayer.component.video.control.ControlWidget;
import com.samsungxr.videoplayer.component.video.control.ControlWidgetListener;
import com.samsungxr.videoplayer.component.video.dialog.OnPlayNextListener;
import com.samsungxr.videoplayer.component.video.dialog.PlayNextDialog;
import com.samsungxr.videoplayer.component.video.loading.LoadingAsset;
...
import com.samsungxr.videoplayer.component.video.player.PlayerListenerDispatcher;
import com.samsungxr.videoplayer.component.video.title.OverlayTitle;
import com.samsungxr.videoplayer.focus.FocusListener;
import com.samsungxr.videoplayer.focus.Focusable;
import com.samsungxr.videoplayer.focus.PickEventHandler;
import com.samsungxr.videoplayer.model.Video;

import java.util.List;

import static com.samsungxr.videoplayer.component.video.VideoPlayer.ConfigureVideoPlayer.POSITION_BACK_BUTTON;
import static com.samsungxr.videoplayer.component.video.VideoPlayer.ConfigureVideoPlayer.POSITION_CONTROL_WIDGET;
...
public class VideoPlayer extends SXRNode {
    ...
    private void addBackButton() {
        mBackButton = new BackButton(getSXRContext(), R.layout.layout_button_back);
    ...
    private void addBackErrorButton() {
        mBackErrorButton = new BackButton(getSXRContext(), R.layout.layout_button_back_error);
    ...
    private void addPlayNextDialog() {
        mPlayNextDialog = new PlayNextDialog(getSXRContext(), mOnPlayNextListener);
    ...
    private void addTitleOverlay() {
        mOverlayTitle = new OverlayTitle(getSXRContext());
    ...
    private void addLoadingAsset() {
        mLoadingAsset = new LoadingAsset(getSXRContext());
    ...
    private void addMessageText() {
        mMessageText = new MessageText(getSXRContext(), "The video cannot be displayed.\nCheck your network connection and try again.");
    ...
    public void reposition(float[] newModelMatrix) {
        ...
        SXRTransform ownerTrans = mWidgetsContainer.getTransform();
