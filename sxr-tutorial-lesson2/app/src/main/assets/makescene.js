...
function onInit(context)
{
	...
	var headTracker = new GVRNode(context, context.createQuad(0.1, 0.1), trackerTex);
...
function makeBalloon(context) {
	var sphere = new GVRSphereNode(context, true);
...
function makeEnvironment(context)
{
	...
	var environment = new GVRSphereNode(context, 18, 36, false, material, 4, 4);
