...
package com.samsungxr.sample.gvrcardboardaudio;
...
public final class SpatialAudioActivity extends SXRActivity
{
    ...
    private static final class SpatialAudioMain extends SXRMain
    {
        ...
        public void onInit(SXRContext gvrContext) throws Throwable {
            ...
            audioListener = new SXRAudioManager(gvrContext);
            ...
            final SXRAudioSource audioSource = new SXRAudioSource(gvrContext);
            audioListener.addSource(audioSource);
            r2d2Model.attachComponent(audioSource);

            // add a floor
            final SXRTexture texture = gvrContext.getAssetLoader().loadTexture(new SXRAndroidResource(gvrContext, R.drawable.floor));
            SXRSceneObject floor = new SXRSceneObject(gvrContext, 120.0f, 120.0f, texture);
