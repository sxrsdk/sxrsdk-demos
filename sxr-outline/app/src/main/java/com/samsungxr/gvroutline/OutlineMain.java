...
package com.samsungxr.gvroutline;
...
public class OutlineMain extends SXRMain {
    ...
    public void onInit(SXRContext gvrContext) {
        ...
        SXRScene outlineScene = gvrContext.getMainScene();
        ...
        try {
            ...
            // ----------------------------------------------------------------
            // load texture
            SXRTexture texture = gvrContext.getAssetLoader().loadTexture(new SXRAndroidResource(
