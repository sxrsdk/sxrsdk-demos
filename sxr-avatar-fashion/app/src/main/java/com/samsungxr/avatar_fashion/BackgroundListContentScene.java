...
public class BackgroundListContentScene extends BaseContentScene {
    BackgroundListContentScene(SXRContext sxrContext,
                               ...
                               Widget.OnTouchListener homeListener) {
    ...
    class Background implements BitmapAdapter.BitmapGetter {
        ...
        @Override
        public Bitmap get() {
            return BitmapFactory.decodeResource(mSxrContext.getContext()
    ...
    public final List<? extends BitmapAdapter.BitmapGetter> getBackgroundList() {
        ...
        for (final String thumb : mBgWidget.getThumbnailsList()) {
            int thumbResId = getId(mSxrContext.getActivity(), thumb, "raw");
    ...
    private PickerWidget setupHorizontalPicker() {
        Adapter adapter = new BitmapAdapter(mSxrContext, getBackgroundList()) {
            @Override
        ...
        PickerWidget horizontalPicker = new PickerWidget(mSxrContext, adapter,0, 0);
    ...
    private BackgroundWidget mBgWidget;
