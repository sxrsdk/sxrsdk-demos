...
public abstract class BaseContentScene extends ScrollableContentScene {
    protected SXRActivity mActivity;

    public BaseContentScene(SXRContext sxrContext, SXRActivity activity) {
        ...
        mMainWidget = new GroupWidget(sxrContext, properties);
