...
import com.samsungxr.controls.menu.color.ColorsMenu;
import com.samsungxr.controls.menu.motion.MotionMenu;
import com.samsungxr.controls.menu.rotation.RotationMenu;
import com.samsungxr.controls.menu.scale.ScaleMenu;
...
public class MenuHeader extends ControlSceneObject implements ItemSelectedListener {
    ...
    private void createMenuTypes() {
        menus.add(new MotionMenu(getSXRContext()));
        menus.add(new ColorsMenu(getSXRContext()));
        menus.add(new ScaleMenu(getSXRContext()));
    ...
    private void bringMenuToFront() {
        ...
        if (!isSentToFront) {
            ...
            new SXRPositionAnimation(this.getTransform(),
                    ...
                    originalPosition[0],
                    originalPosition[1],
                    originalPosition[2] + Z_HOVER_ANIMATION_OFFSET).start(getSXRContext()
                    .getAnimationEngine());
