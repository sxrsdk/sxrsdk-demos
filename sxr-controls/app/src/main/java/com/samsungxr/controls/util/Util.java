...
public class Util {
    ...
    public static SXRTexture transparentTexture(SXRContext context) {
        return context.getAssetLoader().loadTexture(new SXRAndroidResource(context, R.raw.empty));
    }

    public static SXRTexture whiteTexture(SXRContext context) {
        return context.getAssetLoader().loadTexture(new SXRAndroidResource(context, R.drawable.white));
    }

    public static SXRTexture loadTexture(SXRContext context, int res) {
        return context.getAssetLoader().loadTexture(new SXRAndroidResource(context, res));
    }
    ...
    public static void lookAtYAxis(SXRSceneObject origin, SXRSceneObject destination) {
