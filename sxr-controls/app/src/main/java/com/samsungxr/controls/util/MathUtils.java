...
public class MathUtils {
    ...
    public static float[] direction(SXRTransform origin, SXRTransform dest) {
    ...
    public static float distance(SXRTransform obj1, SXRTransform obj2) {
    ...
    public static float distance(SXRTransform obj1, float[] obj2) {
    ...
    public static float[] rotateDirection(SXRTransform rotationQuat, float[] point)
    {
    ...
    public static float[] quaternionMultiply(SXRTransform quat1, SXRTransform quat2)
    {
